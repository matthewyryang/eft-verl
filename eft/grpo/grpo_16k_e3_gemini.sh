...
EXPERIMENT_NAME="e3-gemini-sft"
MODEL_PATH="/projects/bffc/myang13/e3-gemini/checkpoint-400"
PROJECT_NAME=e3-rl

PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=/projects/bffc/myang13/data/e3-rl-set-final.parquet \
    ...
    trainer.default_local_dir=/projects/bffc/myang13/$PROJECT_NAME/$EXPERIMENT_NAME \
    trainer.nnodes=4 \
